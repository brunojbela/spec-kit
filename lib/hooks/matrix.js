...
const NATIVE = {
  ...
  cursor: {
    ...
    'ledger-record': 'postToolUse + afterShellExecution',
    'docs-check': 'stop + preCompact',
    'docs.sync': 'postToolUse + stop',
  },
  opencode: {
    ...
    'ledger-record': 'file.changed + tool.after.*',
    'docs-check': 'session.idle',
    'docs.sync': 'file.changed',
  },
  codex: {
    'session.classify': 'SessionStart',
    'session.personal-interview': 'SessionStart (isFirstRun)',
  ...
  'gemini-cli': {
    ...
    'session.personal-interview': 'SessionStart (isFirstRun)',
    'interaction.inject-orchestration': 'BeforeAgent',
    'security-gate': 'BeforeTool',
    'ledger-record': 'AfterTool',
    'docs-check': 'AfterAgent',
    'docs.sync': 'AfterTool',
  },
  'antigravity-cli (agy)': {
    'session.classify': 'SessionStart',
...
export const HOOK_EVENTS = {
  ...
  opencode: [
    ...
    { hook: 'ledger-record', event: 'file.changed' },
    { hook: 'docs-check', event: 'session.idle' },
    { hook: 'docs.sync', event: 'file.changed' },
  ],
  codex: [
    { hook: 'session.classify', event: 'SessionStart' },
    { hook: 'session.personal-interview', event: 'SessionStart' },
...
HOOK_EVENTS['antigravity-2.0'] = HOOK_EVENTS['antigravity-cli (agy)'];
HOOK_EVENTS['antigravity-ide'] = HOOK_EVENTS['antigravity-cli (agy)'];
